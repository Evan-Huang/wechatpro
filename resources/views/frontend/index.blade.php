        ...
        <div class="col-sm-12" >
            ...
            <form class="form-horizontal" action="" method="POST">
                <div class="form-group">
                    ...
                    <input type="text" name="clientname" value="{{ !isset($clientname) ? ' ' : old('clientname') ? old('clientname') : $clientname }}" class="form-control" id="clientname" placeholder="请输入姓名 Name">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="email" value="{{ !isset($email) ? ' ' : old('email') ? old('email') : $email }}" class="form-control" id="email" placeholder="请输入電郵 Email">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="phone" value="{{ !isset($phone) ? ' ' : old('phone') ? old('phone') : $phone }}" class="form-control" id="phone" placeholder="请输入手提電話 (區號+號碼)">
                ...
                <div class="form-group">
                    ...
                    <p>&nbsp;勾選此方格表示本人亦已閱讀及了解有關<a href="{{ url('front/terms') }}"><u>條款與細則</u></a>。By checking this box, I have also viewed the <a href="{{ url('front/terms') }}"><u>Terms and Conditions</u></a>.</p>
